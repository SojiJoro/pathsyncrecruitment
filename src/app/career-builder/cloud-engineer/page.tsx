...
export const metadata = {
  title: 'Cloud Engineer Career Path - Pathsync Recruitment',
  description: 'Cloud engineer career path guide for 2025',
};

export default function RolePage() {
  const role = roles.find(r => r.slug === 'cloud-engineer');
