...
export const metadata = {
  title: 'QA Engineer Career Path - Pathsync Recruitment',
  description: 'QA engineer roadmap for ensuring software quality',
};

export default function RolePage() {
  const role = roles.find(r => r.slug === 'qa-engineer');
