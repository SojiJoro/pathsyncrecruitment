...
export const metadata = {
  title: 'Technical Writer Career Path - Pathsync Recruitment',
  description: 'Produce clear, user-friendly technical documentation',
};

export default function RolePage() {
  const role = roles.find(r => r.slug === 'technical-writer');
