...
export const metadata = {
  title: 'Tech Recruiter Career Path - Pathsync Recruitment',
  description: 'Tech recruiter path for connecting talent with roles',
};

export default function RolePage() {
  const role = roles.find(r => r.slug === 'tech-recruiter');
