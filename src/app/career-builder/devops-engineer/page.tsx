...
export const metadata = {
  title: 'DevOps Engineer Career Path - Pathsync Recruitment',
  description: 'DevOps engineer roadmap for UK professionals',
};

export default function RolePage() {
  const role = roles.find(r => r.slug === 'devops-engineer');
