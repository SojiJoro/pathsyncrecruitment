...
export const metadata = {
  title: 'Full Stack Developer Career Path - Pathsync Recruitment',
  description: 'Full stack developer road to landing your first job',
};

export default function RolePage() {
  const role = roles.find(r => r.slug === 'full-stack-developer');
