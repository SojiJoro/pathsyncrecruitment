...
export const metadata = {
  title: 'Blockchain Architect Career Path - Pathsync Recruitment',
  description: 'Architect and design secure, scalable blockchain systems',
};

export default function RolePage() {
  const role = roles.find(r => r.slug === 'blockchain-architect');
