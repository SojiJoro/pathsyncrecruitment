...
export const metadata = {
  title: 'Technical SEO Specialist Career Path - Pathsync Recruitment',
  description: 'Technical SEO specialist path for improving search visibility',
};

export default function RolePage() {
  const role = roles.find(r => r.slug === 'technical-seo-specialist');
