...
export const metadata = {
  title: 'Solutions Architect Career Path - Pathsync Recruitment',
  description: 'Design robust, scalable solutions across technologies',
};

export default function RolePage() {
  const role = roles.find(r => r.slug === 'solutions-architect');
