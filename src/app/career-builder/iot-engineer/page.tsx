...
export const metadata = {
  title: 'IoT Engineer Career Path - Pathsync Recruitment',
  description: 'Design and deploy Internet-of-Things solutions for connected devices',
};

export default function RolePage() {
  const role = roles.find(r => r.slug === 'iot-engineer');
