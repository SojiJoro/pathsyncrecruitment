...
export const metadata = {
  title: 'Bioinformatics Engineer Career Path - Pathsync Recruitment',
  description: 'Combine biology and computation to analyse genomic data',
};

export default function RolePage() {
  const role = roles.find(r => r.slug === 'bioinformatics-engineer');
