...
export const metadata = {
  title: 'Frontend Developer Career Path - Pathsync Recruitment',
  description: 'Beginner-friendly guide to becoming a frontend developer',
};

export default function RolePage() {
  const role = roles.find(r => r.slug === 'frontend-developer');
