...
export const metadata = {
  title: 'Business Analyst Career Path - Pathsync Recruitment',
  description: 'Business analyst career path for bridging tech and business',
};

export default function RolePage() {
  const role = roles.find(r => r.slug === 'business-analyst');
