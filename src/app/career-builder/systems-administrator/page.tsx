...
export const metadata = {
  title: 'Systems Administrator Career Path - Pathsync Recruitment',
  description: 'Systems administrator career path for reliable IT infrastructure',
};

export default function RolePage() {
  const role = roles.find(r => r.slug === 'systems-administrator');
