...
export const metadata = {
  title: 'UX/UI Designer Career Path - Pathsync Recruitment',
  description: 'UX/UI designer career path for beginners',
};

export default function RolePage() {
  const role = roles.find(r => r.slug === 'ux-ui-designer');
