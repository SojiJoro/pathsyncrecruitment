...
export const metadata = {
  title: 'Data Engineer Career Path - Pathsync Recruitment',
  description: 'Data engineer roadmap for high-demand jobs',
};

export default function RolePage() {
  const role = roles.find(r => r.slug === 'data-engineer');
