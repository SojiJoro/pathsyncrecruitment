...
export const metadata = {
  title: 'IT Project Manager Career Path - Pathsync Recruitment',
  description: 'IT project manager path for leading tech initiatives',
};

export default function RolePage() {
  const role = roles.find(r => r.slug === 'it-project-manager');
