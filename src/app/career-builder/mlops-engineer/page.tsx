...
export const metadata = {
  title: 'MLOps Engineer Career Path - Pathsync Recruitment',
  description: 'Automate and manage ML model lifecycle in production',
};

export default function RolePage() {
  const role = roles.find(r => r.slug === 'mlops-engineer');
