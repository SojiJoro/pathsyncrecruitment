...
export const metadata = {
  title: 'Digital Marketing Technologist Career Path - Pathsync Recruitment',
  description: 'Bridge marketing and technology to optimise campaigns',
};

export default function RolePage() {
  const role = roles.find(r => r.slug === 'digital-marketing-technologist');
