...
export const metadata = {
  title: 'Robotics Engineer Career Path - Pathsync Recruitment',
  description: 'Design, program and deploy autonomous robotic systems',
};

export default function RolePage() {
  const role = roles.find(r => r.slug === 'robotics-engineer');
