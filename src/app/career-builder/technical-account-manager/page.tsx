...
export const metadata = {
  title: 'Technical Account Manager Career Path - Pathsync Recruitment',
  description: 'Bridge technical solutions and client success',
};

export default function RolePage() {
  const role = roles.find(r => r.slug === 'technical-account-manager');
