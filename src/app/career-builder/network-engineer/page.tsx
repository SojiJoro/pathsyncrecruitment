...
export const metadata = {
  title: 'Network Engineer Career Path - Pathsync Recruitment',
  description: 'Network engineer roadmap for building secure networks',
};

export default function RolePage() {
  const role = roles.find(r => r.slug === 'network-engineer');
