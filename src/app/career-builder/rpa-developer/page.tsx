...
export const metadata = {
  title: 'RPA Developer Career Path - Pathsync Recruitment',
  description: 'Automate repetitive tasks using robotic process automation',
};

export default function RolePage() {
  const role = roles.find(r => r.slug === 'rpa-developer');
