...
export const metadata = {
  title: 'Backend Developer Career Path - Pathsync Recruitment',
  description: 'Backend developer career path in the UK explained',
};

export default function RolePage() {
  const role = roles.find(r => r.slug === 'backend-developer');
