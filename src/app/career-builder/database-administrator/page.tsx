...
export const metadata = {
  title: 'Database Administrator Career Path - Pathsync Recruitment',
  description: 'Database administrator career path for data reliability',
};

export default function RolePage() {
  const role = roles.find(r => r.slug === 'database-administrator');
