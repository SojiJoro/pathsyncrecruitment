...
export const metadata = {
  title: 'Machine Learning Engineer Career Path - Pathsync Recruitment',
  description: 'Machine learning engineer roadmap without a degree',
};

export default function RolePage() {
  const role = roles.find(r => r.slug === 'machine-learning-engineer');
