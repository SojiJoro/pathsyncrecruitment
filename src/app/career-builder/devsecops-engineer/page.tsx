...
export const metadata = {
  title: 'DevSecOps Engineer Career Path - Pathsync Recruitment',
  description: 'Merge security into DevOps pipelines to deliver secure software fast',
};

export default function RolePage() {
  const role = roles.find(r => r.slug === 'devsecops-engineer');
