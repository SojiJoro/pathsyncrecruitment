...
export const metadata = {
  title: 'Site Reliability Engineer (SRE) Career Path - Pathsync Recruitment',
  description: 'SRE career path for ensuring uptime and reliability',
};

export default function RolePage() {
  const role = roles.find(r => r.slug === 'site-reliability-engineer');
