...
export const metadata = {
  title: 'Digital Forensics Analyst Career Path - Pathsync Recruitment',
  description: 'Investigate digital evidence and support legal cases',
};

export default function RolePage() {
  const role = roles.find(r => r.slug === 'digital-forensics-analyst');
