...
export const metadata = {
  title: 'Data Governance Analyst Career Path - Pathsync Recruitment',
  description: 'Manage data assets and enforce governance policies',
};

export default function RolePage() {
  const role = roles.find(r => r.slug === 'data-governance-analyst');
