  ...
  return (
    <main className="p-6 max-w-5xl mx-auto space-y-12">
      ...
      <header className="bg-teal-700 text-white p-8 rounded-lg text-center shadow-md">
        <h1 className="text-4xl font-bold mb-2">{roleData.title}</h1>
        <p className="text-lg">{roleData.averageSalary}</p>
        ...
        <div className="flex flex-wrap justify-center gap-2 mt-4">
          {roleData.badges.map((badge, index) => (
            <span
              key={index}
              className="bg-white text-teal-700 px-3 py-1 text-xs rounded-full font-semibold shadow"
            >
              {badge}
            </span>
          ))}
      ...
      {/* Certifications */}
      {roleData.certifications.length > 0 && (
        <section>
      ...
      <section>
        ...
        <ol className="space-y-6">
          {roleData.learningPath.map((step, index) => (
      ...
      <section className="bg-gray-50 p-8 rounded-lg shadow-inner text-center">
        ...
        <div className="flex flex-col sm:flex-row justify-center gap-4">
          <a
            href="/contact"
            className="bg-teal-600 text-white px-6 py-3 rounded font-semibold hover:bg-teal-700 transition"
          >
            Book a Free Session
          </a>
          <a
            href="/contact"
            className="bg-white text-teal-600 border border-teal-600 px-6 py-3 rounded font-semibold hover:bg-teal-50 transition"
          >
            Book Training
          </a>
        </div>
