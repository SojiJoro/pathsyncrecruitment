...
export const metadata = {
  title: 'Software Engineer Career Path - Pathsync Recruitment',
  description: 'How to become a software engineer in the UK with no experience',
};

export default function RolePage() {
  const role = roles.find(r => r.slug === 'software-engineer');
