...
export const metadata = {
  title: 'Blockchain Developer Career Path - Pathsync Recruitment',
  description: 'Blockchain developer roadmap for decentralized apps',
};

export default function RolePage() {
  const role = roles.find(r => r.slug === 'blockchain-developer');
