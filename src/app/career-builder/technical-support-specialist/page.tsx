...
export const metadata = {
  title: 'Technical Support Specialist Career Path - Pathsync Recruitment',
  description: 'Tech support specialist path for customer-facing IT roles',
};

export default function RolePage() {
  const role = roles.find(r => r.slug === 'technical-support-specialist');
