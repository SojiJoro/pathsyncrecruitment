...
export const metadata = {
  title: 'Cloud Security Engineer Career Path - Pathsync Recruitment',
  description: 'Secure cloud infrastructures, protect data and manage identities',
};

export default function RolePage() {
  const role = roles.find(r => r.slug === 'cloud-security-engineer');
