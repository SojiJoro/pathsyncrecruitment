...
export const metadata = {
  title: 'AI Ethics Specialist Career Path - Pathsync Recruitment',
  description: 'Ensure responsible and fair use of AI systems',
};

export default function RolePage() {
  const role = roles.find(r => r.slug === 'ai-ethics-specialist');
