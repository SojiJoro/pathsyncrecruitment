...
export const metadata = {
  title: 'Data Privacy Officer Career Path - Pathsync Recruitment',
  description: 'Ensure organisational compliance with data protection regulations',
};

export default function RolePage() {
  const role = roles.find(r => r.slug === 'data-privacy-officer');
