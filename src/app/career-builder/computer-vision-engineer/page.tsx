...
export const metadata = {
  title: 'Computer Vision Engineer Career Path - Pathsync Recruitment',
  description: 'Use AI to interpret and analyse visual data in real time',
};

export default function RolePage() {
  const role = roles.find(r => r.slug === 'computer-vision-engineer');
