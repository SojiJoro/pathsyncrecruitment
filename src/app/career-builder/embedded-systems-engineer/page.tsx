...
export const metadata = {
  title: 'Embedded Systems Engineer Career Path - Pathsync Recruitment',
  description: 'Develop firmware and low-level software for hardware devices',
};

export default function RolePage() {
  const role = roles.find(r => r.slug === 'embedded-systems-engineer');
