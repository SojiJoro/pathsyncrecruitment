...
export const metadata = {
  title: 'Cybersecurity Analyst Career Path - Pathsync Recruitment',
  description: 'Entry path to a cybersecurity analyst role in the UK',
};

export default function RolePage() {
  const role = roles.find(r => r.slug === 'cybersecurity-analyst');
