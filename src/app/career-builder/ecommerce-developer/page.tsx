...
export const metadata = {
  title: 'E-commerce Developer Career Path - Pathsync Recruitment',
  description: 'Build and customize online retail platforms',
};

export default function RolePage() {
  const role = roles.find(r => r.slug === 'ecommerce-developer');
