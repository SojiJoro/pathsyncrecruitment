...
export const metadata = {
  title: 'Product Manager Career Path - Pathsync Recruitment',
  description: 'Product manager career path guide in tech companies',
};

export default function RolePage() {
  const role = roles.find(r => r.slug === 'product-manager');
