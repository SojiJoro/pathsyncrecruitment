...
export const metadata = {
  title: 'Data Analyst Career Path - Pathsync Recruitment',
  description: 'Data analyst career path guide for beginners',
};

export default function RolePage() {
  const role = roles.find(r => r.slug === 'data-analyst');
