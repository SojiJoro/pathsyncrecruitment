...
export const metadata = {
  title: 'Site Reliability Security Engineer Career Path - Pathsync Recruitment',
  description: 'Combine reliability engineering and security in production systems',
};

export default function RolePage() {
  const role = roles.find(r => r.slug === 'sre-security-engineer');
