...
export const metadata = {
  title: 'AI Engineer Career Path - Pathsync Recruitment',
  description: 'AI engineer career path for ambitious developers',
};

export default function RolePage() {
  const role = roles.find(r => r.slug === 'ai-engineer');
