...
export const metadata = {
  title: 'Mobile App Developer Career Path - Pathsync Recruitment',
  description: 'Mobile app developer roadmap for iOS and Android',
};

export default function RolePage() {
  const role = roles.find(r => r.slug === 'mobile-app-developer');
