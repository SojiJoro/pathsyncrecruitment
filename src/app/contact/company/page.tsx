// File: app/contact/company/page.tsx
'use client'
...
export default function CompanyContactPage() {
  ...
  const locations: string[] = [
    ...
    "Northampton", "Aldershot", "Basingstoke", "Guildford", "Reading", "Slough",
    "Woking", "High Wycombe", "Chelmsford", "Maidstone", "Bedford", "Rugby",
    "Doncaster", "Salisbury", "Hereford", "Lancaster", "Grimsby", "Gillingham",
    "Worthing", "Banbury", "Cannock"
  ]

  const techRoles: string[] = [
    ...
    "Cybersecurity Specialist", "QA Tester", "Site Reliability Engineer", "Product Manager",
    "Scrum Master", "IT Support", "UX/UI Designer", "AI/ML Engineer", "Technical Project Manager",
    "Mobile App Developer", "Blockchain Developer", "Game Developer", "Database Administrator",
    "Network Engineer", "Systems Administrator", "Security Analyst", "Data Engineer",
    "Machine Learning Engineer", "DevSecOps Engineer", "Front-end Architect", "Back-end Architect",
    "Cloud Engineer", "Infrastructure Engineer", "IoT Developer", "Other"
  ]

  const enquiryTypes: string[] = [
    "Tech Recruitment Partnership", "Hiring for a Contract Role", "Hiring for a Permanent Role",
    "Need Bulk Hiring Support", "Exploring Talent Pipelines or On-Demand Hiring",
    "Discussing Tech Recruitment Process Outsourcing (RPO)", "Looking for Market Insight / Salary Benchmarking",
    "Other"
  ]
  ...
  async function handleSubmit(e: FormEvent<HTMLFormElement>) {
    ...
    if (res.ok) {
      ...
      setFormData({
        firstName: '', lastName: '', jobTitle: '', email: '', companyName: '', phone: '',
        seniority: '', location: '', expertise: '', customExpertise: '', expectedHires: '',
        enquiryType: '', message: '', consent: false
      })
  ...
  return (
    <section className="contact_section company_contact_section">
      ...
      >
        ...
        <form onSubmit={handleSubmit} encType="multipart/form-data" className="contact_form">
          <input
            type="text"
            name="firstName"
