        ...
        <div className="grid lg:grid-cols-3 gap-8">
          {sections.map((section, index) => (
            <motion.div
              ...
              viewport={{ once: true }}
            >
              <div className={`w-16 h-16 rounded-xl bg-${section.color}-100 flex items-center justify-center mb-6`}>
                <div className={`w-8 h-8 rounded-lg bg-${section.color}-500`} />
              </div>
              ...
              <p className={`text-${section.color}-600 font-semibold mb-4`}>
                {section.subtitle}
              </p>
              ...
              <ul className="space-y-3 mb-8">
                {section.features.map((feature, featureIndex) => (
                  <li key={featureIndex} className="flex items-start">
                    <div className={`w-2 h-2 rounded-full bg-${section.color}-500 mt-2 mr-3 flex-shrink-0`} />
              ...
              <Link 
                href={section.href}
                className={`block w-full text-center bg-${section.color}-600 hover:bg-${section.color}-700 text-white px-6 py-3 rounded-lg font-semibold transition-colors`}
              >
                {section.cta}
              </Link>
            </motion.div>
